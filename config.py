...
class TestConfig(Config):
    SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://moringascool:access@localhost/pitches_test'
...
class DevConfig(Config):
    ...
    """
    SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://moringascool:access@localhost/pitches'
    DEBUG = True
